...
button=component:copy({
  ...
  initialize=function(self,...)
    component.initialize(self,...)
    self.c.spr=0
    if (self.flipx) self.c._pos-=v({8,0})
  end,
  tick=function(self)
...
robotclass=component:copy({
  ...
  initialize=function(self,...)
    ...
    self.bumpers={
      self:add(empty_output,64,7,{cfacing=south}),
      self:add(empty_output,7,65,{cfacing=east}),
      self:add(empty_output,62,120,{cfacing=north}),
      self:add(empty_output,120,63,{cfacing=west}),
    }
    self.thrusters={
      self:add(empty_input,75,15,{cfacing=south}),
      self:add(empty_input,15,53,{cfacing=east}),
      self:add(empty_input,73,112,{cfacing=north}),
      self:add(empty_input,112,51,{cfacing=west}),
    }
    self.components={
      self:add(toggle,100,80),
      self:add(toggle,100,96),
  ...
  interact_with=function(self,other)
    other:interact(self)
    if (self.tutorial) self.switch.powered=false
  end,
  tick=function(self)
  end,
  draw=function(self)
    ...
    [1]={
      [2]={
        actors={
          ...
          door:new(v{120,100}, {doorway={0,1,1,2},facing=west}),
          switch:new(v{100,116}),
          and_:new(v{107,76}),
...

...

...

...

...
__map__

