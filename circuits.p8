...
room:new(2,0,{
  actors={
    {button,117,20,{cfacing=south,coffs=v{-5,14},reset=3}},
    {door,92,52,{doorway={1,1,3,1},cfacing=east,coffs=v{3,0}}},
    {button,11,116,{flipx=true,cfacing=east,coffs=v{3,-5},reset=3}},
...
room:new(2,1,{
  actors={
    ...
    {door,100,68,{doorway={0,-2,0,-1},cfacing=east,walltile=64}},
    {key,112,56,{id=3}},
...
room:new(3,0,{
  actors={
    {button,109,116,{reset=2,cshow=false,cfacing=south}},
    {robot_spawner,112,104,{cfacing=east,robot_id=2,coffs=v{17,0}}},
    {button,53,28,{cshow=false,cfacing=south,reset=2}},
    {splitter,10,14},
...
room:new(4,0,{
  actors={
    {button,11,12,{reset=2,cshow=false,flipx=true,cfacing=south,coffs=v{2,0}}},
    {robot_spawner,24,16,{robot_id=3,cfacing=north,coffs=v{7,-10}}},
    {button,117,116,{cshow=false,cfacing=south}},
    {splitter,122,4},
...
room:new(4,1,{
  actors={
    {button,109,68,{reset=2,cshow=false,cfacing=south}},
    {robot_spawner,112,56,{robot_id=4,coffs=v{17,0},cfacing=east}},
    {button,27,68,{flipx=true,cfacing=south,cshow=false,coffs=v{2,0}}},
    {door,59,94,{doorway={0,1,0,3},walltile=64,cfacing=north}},
    {key,16,112,{id=4}},
  },
...

...

...

...

...
__gff__

...

__sfx__
