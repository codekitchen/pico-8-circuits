...
types.toggle=component:copy({
  movable=true,
  connections={i(-6,1),i(4,2),o(-5,-4),o(5,-3)},
  spr=19,
  w=2,
  active=1,
  tick=function(self)
...
robotclass=component:copy({
  ...
  initialize=function(self,...)
    ...
    self.robot_room=room:new(self.room_coords.x/128,self.room_coords.y/128,{ actors=actors, text=text })
...
relay/7/108/facing=east
arrow/65/52/facing=north/text=1
|{1,1,7,1
{7,2,2,1
{8,1,3,1
{8,2,4,1
